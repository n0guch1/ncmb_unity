...
namespace NCMB.Internal
{
	public class NCMBConnection
	{
		...
		public UnityWebRequest _request = null;
		...
		{
			GameObject gameObj = GameObject.Find ("NCMBManager");
			NCMBManager manager = gameObj.GetComponent<NCMBManager> ();
			manager.Connection (this, callback);
		}
		...
		public static IEnumerator SendRequest (NCMBConnection connection, UnityWebRequest req, object callback)
		{
